      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview  {{ $prefix == '/brand' ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            <li class = "{{ $route == 'brand.list' ? 'active' : '' }}"><a href="{{ route('brand.list') }}"><i class="ti-more"></i>View Brand</a></li>
        ...
        <li class="treeview {{ $prefix == '/category' ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            <li class = "{{ $route == 'category.list' ? 'active' : '' }}"><a href="{{ route('category.list') }}"><i class="ti-more"></i>View Category</a></li>
            <li class = "{{ $route == 'sub.category.list' ? 'active' : '' }}"><a href="{{ route('sub.category.list') }}"><i class="ti-more"></i>Sub Category</a></li>
             <li class = "{{ $route == 'sub.subcategory.list' ? 'active' : '' }}"><a href="{{ route('sub.subcategory.list') }}"><i class="ti-more"></i>Sub-Sub Category</a></li>
       ...
       <li class="treeview {{ $prefix == '/product' ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
           ...
           <li class = "{{ $route == 'product.list' ? 'active' : '' }}"><a href="{{ route('product.list') }}"><i class="ti-more"></i>Manage Products</a></li>
          </ul>
        </li> 		  
