...
<div class="content-wrapper">
  ...
  <form method="post" action="" >
	...
	@foreach($brand as $br)	
 <option value="{{ $br->id }}" {{ $br->id === $product->brand_id ? 'selected' : '' }} >{{ $br->brand_name_en }}</option>	
	@endforeach
		</select>
		@error('brand_id') 
	...
	<div class="controls">
		<select name="subcategory_id" class="form-control" required="" >
            ...
            @foreach($sub_category as $sub)			
             <option value="{{ $sub->id }} {{ $sub->id ===  $product->subcategory_id ? 'selected' : '' }}"  ></option>	
            @endforeach
		</select>
...
<div class="row"> <!-- start 2nd row  -->
	...
	@foreach($subsubcategory as $sub)	
        <option value="{{ $sub->id }}" {{  $sub->id === $product->subsubcategory_id }}>{{ $sub->subsubcategory_name_en }}</option>	
    @endforeach
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="controls">
	 <input type="text" name="product_color_hin" class="form-control" value="product_color_hn" data-role="tagsinput" required="">
...
<div class="row"> <!-- start 6th row  -->
	...
	<div class="col-md-6">
	   	...
	   	<div class="form-group">
			...
			<div class="controls">
            <input type="text" name="product_color_hin" class="form-control" value="{{ $product->selling_price }}" data-role="tagsinput" required="">
     @error('selling_price') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 	  </div>
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	 <input type="text" name="selling_price" class="form-control" required="" value="{{ $product->discount_price }}">
